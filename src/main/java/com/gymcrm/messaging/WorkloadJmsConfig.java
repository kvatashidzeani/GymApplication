...
/**
 * ActiveMQ JMS producer configuration for asynchronous workload notifications.
 */
@Configuration
@EnableJms
@ConditionalOnProperty(name = "gymcrm.workload.messaging.enabled", havingValue = "true", matchIfMissing = true)
